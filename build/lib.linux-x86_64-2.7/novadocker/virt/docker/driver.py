...
class DockerDriver(driver.ComputeDriver):
    ...
    def spawn(self, context, instance, image_meta, injected_files,
        ...
        image = self.docker.inspect_image(self._encode_utf8(CONF.docker.docker_image_name))
        if not image:
	...
	self._retrieve_and_inject_jar_in_container(context, container_id, image_meta['id'], "/bin/bridge", full_name)
